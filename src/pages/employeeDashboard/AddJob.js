...
import { usePostJobMutation } from "../../redux/features/api/api.slice";
import { ToastContainer, toast } from "react-toastify";
import Loading from "../../components/reusable/Loading";
import { useSelector } from "react-redux";
const notify = () => toast("Job post successfully");

const AddJob = () => {
  const [postJob, { isLoading, isSuccess, requestId }] = usePostJobMutation()
  const { companyName, _id } = useSelector(rootUser => rootUser.authentiaction.user)
